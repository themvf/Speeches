'use client';
import {OperationsAdmin} from '@/components/backpack/operations-admin';
import {WalletAdmin} from '@/components/backpack/wallet-admin';
