...
export async function GET(request:Request){
 ...
 const start=coin==='PONS'?'2026-07-01':'2026-07-25',campaignId=coin==='STANDARD'?'standard-history-unconfigured':coin==='DPONS'?'dpons-july-2026':coin==='PONS'?'pons-july-2026':'zcat-july-2026';
