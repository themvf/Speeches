...
export async function GET(request:Request){
 ...
 const start=coinConfig(coin).archiveStart,campaignId=coin==='STANDARD'?'standard-history-unconfigured':coin==='DPONS'?'dpons-july-2026':coin==='PONS'?'pons-july-2026':'zcat-july-2026';
