...
// Static pilot snapshot (SEC-17/SEC-19) - statically imported so this route
// has zero network/DB dependency until SEC-9/SEC-10's live pipeline lands.
// isLive: false is load-bearing for the UI's "static snapshot" labeling;
// don't flip it without also wiring a live data source.
export async function GET() {
  ...
  const data: MarketKpiData = {
    ...
    companies,
    warning: "Static pilot snapshot (SEC-17) - not a live feed. Live daily ingestion is scoped in JIRA SEC-9/SEC-10.",
  };
