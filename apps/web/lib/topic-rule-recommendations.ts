...
export const TOPIC_RULE_RECOMMENDATIONS: readonly TopicRuleRecommendation[] = [
  ...
  },
  {
    ...
    sortOrder: 12,
    focus:
      "Public offerings, exempt offerings, private capital, direct participation and non-traded products, crowdfunding, and capital access policy.",
    suggestedKeywords: [
      "capital formation",
      "IPO",
    ...
    broadTerms: ["capital", "offering", "funding", "venture", "startup", "reit", "program"],
    notes: [
      ...
      "Bare REIT matches every REIT earnings and share-price story; qualify it as non-traded REIT or REIT offering so only the offering side lands here.",
      "Direct participation, non-traded REIT/BDC, DST, and interval-fund terms belong here rather than in Investment Products, because the product is defined by how it is offered."
    ]
  },
  {
    topicKey: "PRE_IPO",
