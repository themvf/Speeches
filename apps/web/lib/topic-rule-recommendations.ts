import {
  ...
  CAPITAL_FORMATION_FOCUS,
  CAPITAL_FORMATION_KEYWORDS,
  CAPITAL_FORMATION_LABEL,
  CAPITAL_FORMATION_NOTES,
...
export const TOPIC_RULE_RECOMMENDATIONS: readonly TopicRuleRecommendation[] = [
  ...
  {
    // Sourced from capital-formation-vocabulary.json. Edit the vocabulary
    // there, not here - six other surfaces read the same file.
    topicKey: CAPITAL_FORMATION_TOPIC_KEY,
    label: CAPITAL_FORMATION_LABEL,
    sortOrder: CAPITAL_FORMATION_SORT_ORDER,
    focus: CAPITAL_FORMATION_FOCUS,
    suggestedKeywords: [...CAPITAL_FORMATION_KEYWORDS],
    broadTerms: [...CAPITAL_FORMATION_BROAD_TERMS],
    notes: [...CAPITAL_FORMATION_NOTES]
  },
  {
    topicKey: "PRE_IPO",
  ...
  {
    topicKey: "PONZI_INVESTOR_FRAUD",
    label: "Ponzi Schemes & Investor Fraud",
    sortOrder: 45,
    focus: "Ponzi schemes, pyramid schemes, investment scams, offering fraud, misappropriation of investor funds, and retail investor fraud.",
    suggestedKeywords: [
      "Ponzi scheme",
      "Ponzi schemes",
      "pyramid scheme",
      ...
      "stolen investor funds",
      "diverted investor funds",
      "fake investment",
      "guaranteed returns",
      "guaranteed return",
      "unregistered offering fraud",
      "crypto investment fraud",
      "crypto investment scam",
      "romance scam",
      "pig butchering"
    ],
    broadTerms: ["investment scam", "offering fraud", "securities fraud"],
    notes: [
      "This is a high-signal child topic of Enforcement for retail and securities-fraud schemes.",
      "Avoid standalone fraud or investor as keywords; require investment, offering, scheme, scam, or investor-funds context."
    ]
  },
  {
    topicKey: "AI_TECH",
